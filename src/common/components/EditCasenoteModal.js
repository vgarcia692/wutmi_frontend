  ...
  postClosureUpdate = (() => {
    ...
    .then(function(response) {
      if (response.status==201) {
        // Refresh the form values
        closure = {protection_order:false}
        this.setState({ closure });
        this.props.onAdd();
      }
    }.bind(this))
      ...
      <Modal show={this.props.show} onHide={this.props.onHide} bsSize="large" aria-labelledby="contained-modal-title-lg">
        ...
        <Modal.Body>
          <form>
            ...
            {
              this.props.support_period.closure != null && this.props.support_period.closure.protection_order == 1 ?
                <FormGroup controlId="closure_protection_order">
                  <Checkbox disabled id="closure_protection_order" onChange={this.handleChange} defaultChecked={this.props.support_period.closure != null ? this.props.support_period.closure.protection_order : false }>Has Protection Order</Checkbox>
                </FormGroup>
              :
                <FormGroup controlId="closure_protection_order">
            ...
            {
              this.state.closure.protection_order == true || this.props.support_period.closure.protection_order == true ?
                Constants.IsFirefox ?
